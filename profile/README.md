...
**Open-source server & hosting management that doesn't suck.**



No license fees. No per-server tolls. No vendor lock-in. Just software you own.
...
Full docs coming soon. In the meantime, check out [**Core**](https://github.com/serversinc/core).

## Contributing
Serversinc is in active development. Issues, PRs, and feedback are welcome — see CONTRIBUTING.md.

## License
All Serversinc packages are released under the [MIT License](./LICENSE).

---

Built across all timelines by [humans](https://maxdiamond.co.uk).
